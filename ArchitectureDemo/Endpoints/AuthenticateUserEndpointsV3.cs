...
public static class AuthenticateUserEndpointsV3
{
    public static void AddAuthenticateUserRoute(this IEndpointRouteBuilder app)
    {
        app.MapPost("authenticate", Handle);
    }

    private static async Task<IResult> Handle(LoginRequest request, IApplicationDbContext applicationDbContext)
    {
