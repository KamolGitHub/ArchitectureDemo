...
{
    public static void AddUserRoutesV2(this IEndpointRouteBuilder app)
    {
    ...
    private static async Task<IResult> Authenticate(LoginRequest request, IApplicationDbContext applicationDbContext)
    {
